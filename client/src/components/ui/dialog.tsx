...
const DialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> &
    DialogPosition
>(({ className, setIsOpen, children, position, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        `fixed left-[50%] top-[50%] z-50 grid  max-w-full translate-x-[-50%] translate-y-[-50%] 
        gap-4 bg-background p-6 shadow-lg  data-[state=open]:animate-in data-[state=open]:duration-300
         data-[state=closed]:fade-out-0 data-[state=closed]:duration-300 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95
